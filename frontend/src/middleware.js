...
export function middleware(request) {
    ...
    if (role === 'student') {
        ...
        // Suspended students: Only allow access to `/student/youthForm`
        if (status === 'suspended' && studentPath !== '/student/youthForm') {
            return NextResponse.redirect(new URL('/student/youthForm', request.url));
        }

        // Active students: Deny access to `/student/youthForm`
