	...
	return (
		<section className="relative w-full overflow-hidden bg-pink-200/50">
        	...
        	{/* Hero Content */}
              ...
              <h1
                className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-900 mb-3 md:mb-6 px-2"
      ...
      {/* Curved Cards Section */}
			<section className="max-w-screen-xl mx-auto ">
				<div className="flex flex-col justify-evenly items-center gap-6 md:flex-row bg-gradient-to-b from-pink-200 to-indigo-100 p-6 rounded-lg">
					{data.map((item) => (
						<CurvedCard
							key={item.id}
							id={item.id}
