<x-layout title="Edit Blog">
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg mb-6 p-6 " dir="rtl">
            <h1 class="text-3xl font-bold text-gray-800">تعديل المدونة</h1>
        </div>
            ...
            <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    <x-form.textarea name="content" label="المحتوى" placeholder="ادخل المحتوى هنا ....."
                        icon="fas fa-clipboard-list" required :value="$blog->content" />
            ...
            'published' => 'منشور'
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start ">
                    ...
                    <x-form.Input name="meta_title" label="عنوان ( Meta )" type="text" icon="fas fa-tag"
                        placeholder="أدخل عنوان الميتا" value="{{ $blog->meta_title }}" />
                    ...
                    <x-form.Input name="meta_keywords" label="كلمات ( Meta ) المفتاحية" type="text" icon="fas fa-key"
                        ...
                        value="{{ implode(', ', json_decode($blog->meta_keywords, true) ?? []) }}" />
                ...
                <div>
                    <x-form.textarea name="meta_description" label="وصف ( Meta )"
                        placeholder="ادخل وصف الميتا هنا ....." icon="fas fa-clipboard-list" required
               ...
               transition-all duration-300">
                        ...
                        <span class="font-normal">تحديث المقال</span>
                    </button>
                </div>
