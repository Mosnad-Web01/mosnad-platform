...
const Navbar = () => {
  ...
  console.log("role is = " + user?.role_id);
              ...
              {!user ? (
                ...
                <div className="hidden md:flex items-center gap-4">
                  <Link
                    ...
                    className="rounded-full p-2 flex flex-row-reverse items-center gap-2 text-sm font-medium text-gray-700 hover:bg-gray-200 transition"
                  >
