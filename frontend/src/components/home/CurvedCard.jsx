...
const CurvedCard = ({ image, title, subtitle }) => {
  return (
    <div className="flex gap-6 justify-center items-center bg-white/40 shadow-md rounded-full w-full max-w-xs p-6 hover:shadow-lg transition-shadow duration-300">
